...
with xlsxwriter.Workbook('Terms_per_combo.xlsx', {'nan_inf_to_errors': True}) as workbook:
# Create new worksheet and print keys at the top
    worksheet = workbook.add_worksheet()
    d = pd.read_excel('/Users/kevinvela/Desktop/Kev/Pairs_Found.xlsx', sheet_name=1)
    keyss = d.keys()
